...
public:
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UINavController|TumbstickAsMouse")
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UINavController|ThumbstickScroll")
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "UINavController|KeyDisplay", meta = (RequiredAssetDataTags = "RowStructure=/Script/UINavigation.InputIconMapping"))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "UINavController|KeyDisplay", meta = (RequiredAssetDataTags = "RowStructure=/Script/UINavigation.InputNameMapping"))
